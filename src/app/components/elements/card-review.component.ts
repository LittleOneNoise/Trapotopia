...
@Component({
  ...
  template: `
    <div
      class="relative bg-surface-700 p-8 rounded-2xl border border-border-surface-700 shadow-2xl max-w-md w-full">

      <div class="flex justify-between items-center mb-6">

        <div class="flex flex-col gap-1.5">
          <h3 class="text-lg tracking-tight leading-tight">
            {{ reviewerName() }}
          </h3>
        ...
        <div
          class="w-16 h-16 shrink-0 rounded-full border border-white/10 overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.6)] relative">
          <img
